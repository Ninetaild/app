...
export const GoogleSheetsModal: React.FC<GoogleSheetsModalProps> = ({ isOpen, onClose }) => {
  ...
  const syncNow = async () => {
    if (!spreadsheetUrl) { setMessage('먼저 Google Sheets URL을 저장해 주세요.'); return; }
